...
import { CalendarDays, FileText, FolderOpen, Home, LogOut, Search, Settings, UserRound } from "lucide-react";
      ...
      >
        <div className="flex h-full flex-col p-4">
          ...
          <nav className="mt-6 flex-1 space-y-2">
            ...
            <SidebarItem to="/patient/profile" icon={<UserRound size={18} />} label="Profil" />
            <SidebarItem to="/patient/settings" icon={<Settings size={18} />} label="Parametres" />
          </nav>
